...
class FactRequirementRegistry:
    ...
    def __init__(self) -> None:
        self._registry: Dict[str, FactRequirement] = {
            ...
            "manufacturing_step_logs": FactRequirement(
                fact_key="manufacturing_step_logs",
                question_template="Provide manufacturing step logs that describe the transformation process.",
                evidence_types=["manufacturing_step_logs"],
                measurement_hint="Include operations, dates, and country for each step.",
            ),
            "labor_cost_summary": FactRequirement(
                fact_key="labor_cost_summary",
                question_template="Provide a labor cost summary for regional value content calculations.",
                evidence_types=["labor_cost_summary"],
                measurement_hint="Include total labor and overhead by country for the unit.",
            ),
            "sub_supplier_cert_origin": FactRequirement(
                fact_key="sub_supplier_cert_origin",
                question_template="Provide sub-supplier certifications of origin for key materials/components.",
                evidence_types=["sub_supplier_cert_origin"],
                measurement_hint="Attach certificates or declarations for each critical component.",
            ),
