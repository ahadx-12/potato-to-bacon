...
DUTY_RATES = {
    ...
    "HTS_ELECTRONICS_WIRE_HARNESS": 1.5,
    "HTS_ELECTRONICS_SIGNAL_LOW_VOLT": 1.0,
    "HTS_ELECTRONICS_ACTIVE_CABLE": 1.25,
...
def tariff_policy_atoms() -> List[PolicyAtom]:
    ...
    atoms: list[PolicyAtom] = [
        ...
        PolicyAtom(
            guard=["electronics_cable_or_connector", "electronics_has_connectors"],
            outcome={
                "modality": "OBLIGE",
            ...
            text="Electronics classified primarily as cables/connectors with documented connector evidence.",
            rule_type="TARIFF",
            atom_id="HTS_ELECTRONICS_CONNECTOR_atom",
        ),
        PolicyAtom(
            guard=[
                "electronics_is_cable_assembly",
                "electronics_has_connectors",
                "electronics_insulated_conductors",
            ],
            outcome={
                "modality": "OBLIGE",
                "action": "duty_rate_1_5",
                "subject": "import_duty",
                "jurisdiction": "US",
            },
            source_id="HTS_ELECTRONICS_WIRE_HARNESS",
            statute="HTS",
            section="ELECTRONICS_WIRE_HARNESS",
            text="Wire harness or cable assembly with insulated conductors.",
            rule_type="TARIFF",
            atom_id="HTS_ELECTRONICS_WIRE_HARNESS_atom",
        ),
        PolicyAtom(
            guard=[
                "electronics_is_cable_assembly",
                "electronics_has_connectors",
                "electronics_insulated_conductors",
                "electronics_voltage_rating_known",
            ],
            outcome={
                "modality": "OBLIGE",
                "action": "duty_rate_1_0",
                "subject": "import_duty",
                "jurisdiction": "US",
            },
            source_id="HTS_ELECTRONICS_SIGNAL_LOW_VOLT",
            statute="HTS",
            section="ELECTRONICS_SIGNAL_LOW_VOLT",
            text="Low-voltage signal cable assemblies (e.g., USB/HDMI class) with insulation and connectors.",
            rule_type="TARIFF",
            atom_id="HTS_ELECTRONICS_SIGNAL_LOW_VOLT_atom",
        ),
        PolicyAtom(
            guard=[
                "electronics_is_cable_assembly",
            ...
            outcome={
                "modality": "OBLIGE",
                "action": "duty_rate_1_25",
                "subject": "import_duty",
                "jurisdiction": "US",
            },
            source_id="HTS_ELECTRONICS_ACTIVE_CABLE",
            statute="HTS",
            section="ELECTRONICS_ACTIVE_CABLE",
            text="Active cable assemblies with embedded PCB or signaling components.",
            rule_type="TARIFF",
            atom_id="HTS_ELECTRONICS_ACTIVE_CABLE_atom",
        ),
        PolicyAtom(
