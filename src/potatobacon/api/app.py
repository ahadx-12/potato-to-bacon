...
from potatobacon.api.routes_proofs import router as proofs_router, tariff_proofs_router
...
from potatobacon.storage import save_manifest, latest_manifest_hash
...
app = FastAPI(
    title="CALE Tariff API",
    description="Tariff Engineering-as-a-Service: Z3-backed HTS classification, optimization, and cryptographic proof generation.",
    version="v1",
    lifespan=lifespan,
)
app.add_middleware(
...
app.include_router(tariff_proofs_router)
...
if web_dir.exists():
    ...
    print(f"Warning: UI directory not found at {web_dir}, skipping UI mount.")
...
def info() -> Dict[str, Any]:
    return {
        "product": "CALE Tariff (TEaaS)",
        "version": "0.1.0",
        "git_sha": os.getenv("GIT_COMMIT"),
        "capabilities": [
            "hts_classification",
            "duty_optimization",
            "overlay_analysis_232_301",
            "origin_engineering_usmca",
