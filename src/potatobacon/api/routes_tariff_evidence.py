...
async def upload_evidence(file: UploadFile = File(...)) -> EvidenceRecord:
    ...
    try:
        ...
        record = store.save(payload, filename=file.filename or "evidence", content_type=file.content_type)
